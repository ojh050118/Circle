...
namespace Circle.Game.Tests.Visual.PostProcessing
{
    public partial class TestScenePostProcessingContainer : CircleTestScene
    {
        ...
        private void load()
        {
            ...
            AddSliderStep("Aberration filter Intensity", 0f, 200f, 100f, v => postProcessing.Aberration.Intensity = v);
            ...
            AddSliderStep("Blizzard filter Intensity", 0f, 200f, 100f, v => postProcessing.Blizzard.Intensity = v);
            ...
            AddSliderStep("Bloom filter Intensity", 0f, 200f, 100f, v => postProcessing.Bloom.Intensity = v);
            AddSliderStep("Bloom filter Threshold", 0, 1, 0.5f, v => postProcessing.Bloom.Threshold = v);
            ...
            AddSliderStep("Blur filter Intensity", 0f, 200f, 100f, v => postProcessing.Blur.Intensity = v);
            ...
            AddSliderStep("Blur Focus filter Intensity", 0f, 200f, 100f, v => postProcessing.BlurFocus.Intensity = v);
            ...
            AddSliderStep("Compression filter Intensity", 0f, 200f, 100f, v => postProcessing.Compression.Intensity = v);
            ...
            AddSliderStep("Contrast filter Intensity", 0f, 200f, 100f, v => postProcessing.Contrast.Intensity = v);
            ...
            AddSliderStep("Drawing filter Intensity", 0f, 200f, 100f, v => postProcessing.Drawing.Intensity = v);
            ...
            AddSliderStep("Fisheye filter Intensity", 0f, 200f, 100f, v => postProcessing.Fisheye.Intensity = v);
            ...
            AddSliderStep("Gaussian Blur filter Intensity", 0f, 200f, 100f, v => postProcessing.GaussianBlur.Intensity = v);
            ...
            AddSliderStep("Grain filter Intensity", 0f, 200f, 100f, v => postProcessing.Grain.Intensity = v);
            ...
            AddSliderStep("Grayscale filter Intensity", 0f, 200f, 100f, v => postProcessing.Grayscale.Intensity = v);
            ...
            AddSliderStep("Hexagon Black filter Intensity", 0f, 200f, 100f, v => postProcessing.HexagonBlack.Intensity = v);
            ...
            AddSliderStep("LED filter Intensity", 0f, 200f, 100f, v => postProcessing.Led.Intensity = v);
            ...
            AddSliderStep("Light Water filter Intensity", 0f, 200f, 100f, v => postProcessing.LightWater.Intensity = v);
            ...
            AddSliderStep("Oil Paint filter Intensity", 0f, 200f, 100f, v => postProcessing.OilPaint.Intensity = v);
            ...
            AddSliderStep("Pixelate filter Intensity", 0f, 200f, 100f, v => postProcessing.Pixelate.Intensity = v);
            ...
            AddSliderStep("Pixel Snow filter Intensity", 0f, 200f, 100f, v => postProcessing.PixelSnow.Intensity = v);
            ...
            AddSliderStep("Posterize filter Intensity", 0f, 200f, 100f, v => postProcessing.Posterize.Intensity = v);
            ...
            AddSliderStep("Rain filter Intensity", 0f, 200f, 100f, v => postProcessing.Rain.Intensity = v);
            ...
            AddSliderStep("Sepia filter Intensity", 0f, 200f, 100f, v => postProcessing.Sepia.Intensity = v);
            ...
            AddSliderStep("Sharpen filter Intensity", 0f, 200f, 100f, v => postProcessing.Sharpen.Intensity = v);
            ...
            AddSliderStep("Static filter Intensity", 0f, 200f, 100f, v => postProcessing.Static.Intensity = v);
            ...
            AddSliderStep("VHS filter Intensity", 0f, 200f, 100f, v => postProcessing.Vhs.Intensity = v);
            ...
            AddSliderStep("Water Drop filter Intensity", 0f, 200f, 100f, v => postProcessing.WaterDrop.Intensity = v);
            ...
            AddSliderStep("Waves filter Intensity", 0f, 200f, 100f, v => postProcessing.Waves.Intensity = v);
