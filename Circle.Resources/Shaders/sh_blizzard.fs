...
void main(void)
{
	...
	u_xlat8.x *= u_xlat1.x;
	u_xlat1.y = u_xlat8.x * 0.03125 + u_xlat4 + m_TexCoord.y;
	...
	u_xlat2.y = u_xlat4 * 0.5 + m_TexCoord.y;
	...
	u_xlat3.y = m_TexCoord.y * 0.5 + u_xlat0.z;
	...
	u_xlat2.y = u_xlat8.y * u_xlat2.x * 0.015625 + m_TexCoord.y;
