...
void main(void)
{
	...
	u_xlat2 = samplePP(m_Texture1, m_Sampler1, TexRect1, getShaderTexturePosition(v_TexCoord, texResolution, s_topLeft));
	...
	u_xlat3 = samplePP(m_Texture1, m_Sampler1, TexRect1, getShaderTexturePosition(u_xlat3.xy + v_TexCoord, texResolution, s_topLeft));
